...
class Telegram:
    ...
    BOT_USERNAME = env.get("TELEGRAM_BOT_USERNAME", "swegos_file_bot")
...
class Server:
    BASE_URL = env.get("BASE_URL", "https://zgkgwgc.greatnews.cloud")
    BIND_ADDRESS = env.get("BIND_ADDRESS", "https://zgkgwgc.greatnews.cloud")
